...
2. В отчете Allure вы увидите:
   - **Название теста**: Например, `Тестирование страницы магазина`.
   - **Описание теста**: Описание, что тест проверяет корректность работы страницы магазина
                     путем выполнения различных операций.
   - **Шаги теста**:
     - Открытие страницы магазина.
     - Авторизация на странице магазина.
     - Выбор вещей на странице магазина.
     - Проверка корзины на наличие выбранных вещей.
